...
export const CategoryForm: React.FC<CategoryFormProps> = ({
    ...
    const toastMessage = initialData ? 'Categoria atualizada.' : 'Categoria criada com sucesso!'
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error('Tenha certeza de que você removeu todas produtos que usam essa categoria')
        } finally {
            setLoading(false)
            setOpen(false)
        }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder='Categoria' {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
